    ...
    <div class="row">
        <div class="col-md-12 dash">
            <div class="panel panel-default">
                <div class="panel-heading">Editar Tipo: {{ $tipo->tipo }}</div>
                    <div class="panel-body">
                        <form method="POST" action=" {{ route('tipo.update', $tipo->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tipoInput" name="tipo" value="{{ $tipo->tipo }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="descricao" id="descricaoTextarea"  rows="4" class="form-control">{{ $tipo->descricao }}</textarea>
